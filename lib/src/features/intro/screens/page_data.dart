  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: Column(
        children: [
          const Spacer(),
          (IntroSizeModel.imageSize + IntroSizeModel.logoHeight)
              .heightSizeBox(),
          SizedBox(
            ...
            child: StaticTextScale(
              child: ListView(
                shrinkWrap: true,
                children: [
                  data.title.toLabel(textStyle: textTheme!.mobileBold16),
                  SizedBox(
                    height: AppStyle().insets.sm,
                  ),
                  data.desc.toLabel(textStyle: textTheme.mobileRegular14),
                ],
              ),
            ),
          ),
          (IntroSizeModel.pageIndicatorHeight).heightSizeBox(),
          const Spacer(
            flex: 2,
          )
        ],
